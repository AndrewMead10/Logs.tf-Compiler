...
export default class Spy extends Component {
  constructor(props) {
    ...
    if (this.props) {
      ...
      this.backstabsOver = this.props.backstabsOver;
      this.backstabs6s = this.props.backstabs6s;
      this.backstabsHL = this.props.backstabsHL;
    } else {
  ...
  insertInfo(json2, id3) {
    ...
    //backstabs
    this.backstabsOver += json2.players[id3].backstabs;
    if (
      Object.keys(json2.players).length === 12 ||
      Object.keys(json2.players).length === 13
    ) {
      this.backstabs6s += json2.players[id3].backstabs;
    } else if (
      Object.keys(json2.players).length === 18 ||
      Object.keys(json2.players).length === 19
    ) {
      this.backstabsHL += json2.players[id3].backstabs;
    }
  }
}
