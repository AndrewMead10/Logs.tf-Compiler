...
export default class Sniper extends Component {
  constructor(props) {
    ...
    if (this.props) {
      ...
      this.headshotsOver = this.props.headshotsOver;
      this.headshots6s = this.props.headshots6s;
      this.headshotsHL = this.props.headshotsHL;
    } else {
  ...
  insertInfo(json2, id3) {
    ...
    if (json2.players[id3].class_stats[0].weapon["sniperrifle"] != null) {
      this.shotsOver +=
        json2.players[id3].class_stats[0].weapon["sniperrifle"].shots;
      if (
        Object.keys(json2.players).length === 12 ||
        Object.keys(json2.players).length === 13
      ) {
    ...
    if (json2.players[id3].class_stats[0].weapon["sniperrifle"] != null) {
      this.hitsOver +=
        json2.players[id3].class_stats[0].weapon["sniperrifle"].hits;
      if (
        Object.keys(json2.players).length === 12 ||
        Object.keys(json2.players).length === 13
      ) {
    ...
    this.headshotsOver += json2.players[id3].headshots;
    if (
      Object.keys(json2.players).length === 12 ||
      Object.keys(json2.players).length === 13
    ) {
      this.headshots6s += json2.players[id3].headshots;
    } else if (
      Object.keys(json2.players).length === 18 ||
      Object.keys(json2.players).length === 19
    ) {
      this.headshotsHL += json2.players[id3].headshots;
    }
  }
}
